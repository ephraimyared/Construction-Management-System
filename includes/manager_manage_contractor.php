...
$query = "SELECT UserID, FirstName, LastName, Email FROM users WHERE Role = 'Contractor'";
...
<div class="dashboard-container">
    <div class="header">
        <h2><i class="fas fa-users-cog"></i> Manage Contractors</h2>
        <p class="text-muted">Below is a list of Contractors</p>
    </div>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="ManagerEdit_contractor.php?id=<?php echo $row['UserID']; ?>" class="btn btn-warning">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Are you sure you want to delete contractor <strong><?php echo $row['FirstName'] . ' ' . $row['LastName']; ?></strong>?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                        <a href="ManagerDelete_contractor.php?id=<?php echo $row['UserID']; ?>" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
