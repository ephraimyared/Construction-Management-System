...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="ContractorProfile.php" class="active">
            ...
            <div class="profile-container">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        <h1 class="profile-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Contractor'; ?></h1>
                    ...
                    <form method="POST" action="" id="profileForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo isset($user['Phone']) ? htmlspecialchars($user['Phone']) : ''; ?>" placeholder="+251 9xxxxxxxx" required>
    ...
    <script>
        ...
        document.getElementById('security_question_2').addEventListener('change', function() {
            ...
            if (this.value === 'birthPlace') {
                helpText.textContent = 'Enter birth year before 2003 ';
        ...
        document.getElementById('profileForm').addEventListener('submit', function(e) {
            ...
            if (!/^\+251[79]\d{8}$/.test(phone)) {
                isValid = false;
                alert('Phone number must be in Ethiopian format: +251 followed by 9 digits starting with 7 or 9');
        ...
        document.getElementById('securityQuestionsForm').addEventListener('submit', function(e) {
            ...
            const answer1 = document.getElementById('security_answer_1').value;
            const answer2 = document.getElementById('security_answer_2').value;
            
            // Check if both questions are selected
            if (!question1 || !question2) {
                alert('Please select both security questions');
                e.preventDefault();
                return;
            }
            ...
            if (!answer1.trim() || !answer2.trim()) {
                alert('Please provide answers for both security questions');
                e.preventDefault();
                return;
            }
            
            // Validate answer format based on question type
            if (question2 === 'birthPlace') {
                // For birth year, validate it's a number and before 2003
                if (!/^\d+$/.test(answer2)) {
                ...
                if (parseInt(answer2) >= 2003) {
                    alert('Birth year must be before 2003');
                    e.preventDefault();
                    return;
                }
            } else {
                // For other questions, validate they contain only letters
                if (!/^[a-zA-Z\s]+$/.test(answer2)) {
                    alert('Answer to question 2 must contain only letters');
                    e.preventDefault();
                    return;
                }
            }
            
            // Validate answer 1 contains only letters
            if (!/^[a-zA-Z\s]+$/.test(answer1)) {
                alert('Answer to question 1 must contain only letters');
                e.preventDefault();
                return;
            }
        });
