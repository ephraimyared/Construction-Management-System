...
// Get contractor info if employee is managed by a contractor
$contractor_info = null;
if (isset($user['managed_by_contractor_id']) && !empty($user['managed_by_contractor_id'])) {
    $contractor_query = "SELECT FirstName, LastName FROM users WHERE UserID = ? AND Role = 'Contractor'";
    $stmt = $connection->prepare($contractor_query);
    $stmt->bind_param("i", $user['managed_by_contractor_id']);
    $stmt->execute();
    $contractor_result = $stmt->get_result();
    if ($contractor_result->num_rows > 0) {
        $contractor_info = $contractor_result->fetch_assoc();
    }
}
?>
...
<head>
    ...
    <style>
        :root {
            --primary:rgb(23, 44, 149);
            --primary-light:rgb(49, 80, 147);
            --primary-dark:rgb(48, 33, 136);
            --secondary: #4361ee;
            --success:rgb(42, 61, 147);
            --info: #3498db;
            --warning: #f39c12;
            --danger: #e74c3c;
            --light: #f8f9fa;
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="EmployeeViewProfile.php" class="active">
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                ...
                <div class="user-details">
                    <div class="user-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Employee'; ?></div>
        ...
        <div class="profile-container">
            ...
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <h1 class="profile-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Employee'; ?></h1>
                    <div class="profile-role">
                        <i class="fas fa-user-hard-hat"></i> Construction Employee
                    </div>
                    <div class="profile-contact">
                        ...
                        <?php if ($contractor_info): ?>
                        <div class="contact-item">
                            <i class="fas fa-user-tie"></i>
                            Reports to: <?php echo htmlspecialchars($contractor_info['FirstName'] . ' ' . $contractor_info['LastName']); ?>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
