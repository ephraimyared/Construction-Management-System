...
$upload_dir = "../uploads/site_engineer_reports/";
...
// If no projects found with the specific role, try a more general query
    ...
    if (!empty($project_id) && !empty($report_type) && !empty($title) && !empty($content)) {
        ...
        if (isset($_FILES['report_file']) && $_FILES['report_file']['error'] == 0) {
            ...
            if (!in_array($file_type, $allowed_types)) {
                ...
                $file_name = time() . '_' . $site_engineer_id . '_' . basename($_FILES['report_file']['name']);
                ...
                if (move_uploaded_file($_FILES['report_file']['tmp_name'], $file_path)) {
                    ...
                    $file_path = 'uploads/site_engineer_reports/' . $file_name;
                } else {
        ...
        if (empty($message)) {
            try {
                ...
                $stmt->bind_param("iisssss", $project_id, $site_engineer_id, $report_type, $title, $content, $file_path, $current_time);
...
<head>
    <meta charset="UTF-8">
    <title>Submit Report | Site Engineer</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="SiteEngineerDashboard.php" class="sidebar-logo">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="SiteEngineerDashboard.php">
            ...
            <li>
                <a href="SiteEngineerSubmitReport.php" class="active">
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                <div class="user-avatar">
                    <?php echo isset($user['FirstName']) ? substr($user['FirstName'], 0, 1) : 'S'; ?>
                </div>
                <div class="user-details">
                    <div class="user-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Site Engineer'; ?></div>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="SiteEngineerDashboard.php">Dashboard</a></li>
        ...
        <div class="report-form-container">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="report_file" class="form-label">Attach File</label>
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="SiteEngineerDashboard.php" class="btn btn-secondary">
