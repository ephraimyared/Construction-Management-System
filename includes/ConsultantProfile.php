        ...
        <div class="profile-container">
            ...
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <h1 class="profile-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Consultant'; ?></h1>
                    <div class="profile-role">
                        <i class="fas fa-briefcase"></i> Consultant
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small id="answer2Help" class="form-text text-muted">
                                        For birth year, enter numbers only (G.C. will be added automatically)
                                    </small>
                                </div>
                            </div>
                        </div>
