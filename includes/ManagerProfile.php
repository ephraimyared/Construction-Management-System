...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="ManagerProfile.php" class="sidebar-logo">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="ManagerProfile.php" class="active">
            ...
            <div class="profile-container">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        <h1 class="profile-name"><?php echo isset($user['FirstName']) ? htmlspecialchars($user['FirstName'] . ' ' . $user['LastName']) : 'Project Manager'; ?></h1>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" value="<?php echo isset($user['Phone']) ? htmlspecialchars($user['Phone']) : ''; ?>" placeholder="+251xxxxxxxxx">
